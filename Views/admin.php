...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/PHP/MVC_Annonces">Accueil du site</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/PHP/MVC_Annonces/admin">Accueil de l'admin </a>
                    </li>
                    <li class="nav-item">
    ...
    <script src="/PHP/MVC_Annonces/Public/js/script.js"></script>
</body>
